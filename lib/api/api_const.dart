const baseUrl = "https://btlsalescrm.cloud/api/";
//const baseUrl = "https://sharchi.equi.website/api/";
// const baseUrl = "http://192.168.0.185:8000/api/";
//const imageUrl = "https://sharchi.equi.website/storage/";
const imageUrl = "https://btlsalescrm.cloud/storage/";
const app_logo = "assets/images/logo.png";
// const imageUrl = "";

const String loginapi = "login";
const String forgetpassword = "password/email";
const String logoutApi = "logout";
const String me = "me";
const String tourplansapi = "tourplans";
const String fetchtourplans = "tourplans";
const String updatetourplans = "tour-plans";
...
const String clockOutApi = "attendance/clock-out";
const String breakStartApi = "attendance/break/start";
...
//expenses
const String expenseCreate = "expenses/create";
const String expenseApprovebulk = "expenses/approve-bulk";
const String allExpense = "expenses/all";
